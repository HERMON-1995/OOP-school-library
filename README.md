...
```sh
  ...
  git clone https://github.com/HERMON-1995/OOP-school-library.git
```
...
Feel free to check the [issues page](https://github.com/HERMON-1995/OOP-school-library/issues).
